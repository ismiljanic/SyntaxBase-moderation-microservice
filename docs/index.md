...
> For any questions about setup, dataset preprocessing, or evaluation scripts, refer to `training_logs.md` or the research paper draft with full documentation `docs.md`.
