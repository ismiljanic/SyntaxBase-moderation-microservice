...
# OUTPUT = Path("results/logs/llm/forum_test_dataset_results_batch_1.csv")
# SUMMARY_OUTPUT = Path("results/logs/llm/forum_test_dataset_summary_batch_1.json")

# INPUT = Path("data/test/llm/forum_test_dataset_for_llm_batch_2.csv")
# OUTPUT = Path("results/logs/llm/forum_test_dataset_results_batch_2.csv")
# SUMMARY_OUTPUT = Path("results/logs/llm/forum_test_dataset_summary_batch_2.json")

# INPUT = Path("data/test/llm/forum_test_dataset_for_llm_batch_3.csv")
# OUTPUT = Path("results/logs/llm/forum_test_dataset_results_batch_3.csv")
# SUMMARY_OUTPUT = Path("results/logs/llm/forum_test_dataset_summary_batch_3.json")

# INPUT = Path("data/test/llm/forum_test_dataset_for_llm_batch_4.csv")
# OUTPUT = Path("results/logs/llm/forum_test_dataset_results_batch_4.csv")
# SUMMARY_OUTPUT = Path("results/logs/llm/forum_test_dataset_summary_batch_4.json")

INPUT = Path("data/test/llm/forum_test_dataset_for_llm_batch_5.csv")
OUTPUT = Path("results/logs/llm/forum_test_dataset_results_batch_5.csv")
SUMMARY_OUTPUT = Path("results/logs/llm/forum_test_dataset_summary_batch_5.json")
