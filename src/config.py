...
BERT_CONFIDENCE_THRESHOLD = float(os.getenv("BERT_CONFIDENCE_THRESHOLD", 0.8))
TOXICBERT_CONFIDENCE_THRESHOLD = float(os.getenv("TOXICBERT_CONFIDENCE_THRESHOLD", 0.8))
